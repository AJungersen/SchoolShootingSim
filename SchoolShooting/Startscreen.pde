...
boolean gameplay;
 ...
 void drawStartScreen(){
   ...
   stroke(179, 31, 31);
   line(width*0.1,height*0.46, width*0.4, height*0.46);
   line(width*0.1,height*0.61, width*0.4, height*0.61);
   ...
   textSize(30);
   text("Press e to pickup item",width*0.08,height*0.4);
   text("Press space to strike shooter",width*0.03,height*0.54);
   text("Use arrow keys to move",width*0.06,height*0.7);
